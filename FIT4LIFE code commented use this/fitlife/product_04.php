...
<head>
	<meta charset="utf-8">
	<title>Performance-Muscle gain</title>
	...
	<div class="container">
			...
			<div id="product-slider" class="carousel slide carousel-fade" data-ride="carousel">
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="images/gain.jpg" height="450px" width="700px" class="d-block" >
					</div>
				</div>
		...
		<div class="col-md-7">
			...
			<form action="cart.php" method="GET">
				...
				<input type="hidden" name="name" value="Performance-Muscle gain">

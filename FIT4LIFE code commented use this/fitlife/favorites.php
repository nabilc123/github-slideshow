<?php require_once 'database/config.php'; genrate_favorites_list(); ?>
<html>
<head>
	<meta charset="utf-8">
			...
			<div class="col-9">
				<div class="card shadow p-3">
					<div class="card-heading">
						<h4 class="text-center text-info">Favorites</h4>
					</div>
					...
					<div class="card-body">
						<div class="table-responsive">
							<table class="table table-bordered">
								...
								<tbody>
									<?php $total=0; get_favorites_list(); ?>
								</tbody>
							</table>
						</div>
						<div class="card-footer text-center">
							<?php if (isset($_SESSION['Favorites']) && count($_SESSION['Favorites']) != 0 ) { echo '<a href="favorites.php?action=clear" class="btn btn-danger">Clear List</a>'; } ?>
							<a href="shop.php" class="btn btn-success">Products</a>
						</div>
					</div>
				</div>
			</div>

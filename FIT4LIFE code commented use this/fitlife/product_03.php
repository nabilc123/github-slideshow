	...
	<div class="container">
			...
			<div id="product-slider" class="carousel slide carousel-fade" data-ride="carousel">
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="images/whey1.jpg" height="450px" width="700px" class="d-block" >
					</div>
					<div class="carousel-item">
						<img src="images/gn.jpg" height="450px" width="300px" class="d-block" >
					</div>
					<div class="carousel-item">
						<img src="images/g.jpg" height="450px" width="400px" class="d-block" >
					</div>
				</div>
		...
		<div class="col-md-7">
			...
			<form action="cart.php" method="GET">
				...
				<input type="hidden" name="name" value="Gold Standard-Whey">
...
<section class="product-description">
	<div class="container">
		...
		<P>Whey Protein Isolates (WPI) are the purest form of whey protein that currently exists. 
			...
			ON's attention to detail also extends to mixability. This superior quality powder has been instantized to mix easily using a shaker cup or just a glass and spoon.
		There's no doubt that this is the standard by which all other whey proteins are measured</P><hr>
	</div>
</section>
